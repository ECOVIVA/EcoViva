          ...
          <div className="flex justify-between items-center">
            ...
            >
              <div className="relative">
                <div className={`absolute inset-0 rounded-full blur-100px] ${isScrolled ? 'bg-green-400/50' : 'bg-green-500/20'} group-hover:bg-green-500/30 transition-all duration-300`}></div>
