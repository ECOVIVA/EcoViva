from apps.community.views import posts_views, threads_views
            ...
            [
                ...
                path(
                    ...
                    include(
                        [
                            path(
                                "create/", posts_views.PostCreateView.as_view(), name="create_post"
                            ),
                            path(
                                "<int:id_post>/update/",
                                posts_views.PostUpdateView.as_view(),
                                name="post_update",
                            ),
                            path(
                                "<int:id_post>/delete/",
