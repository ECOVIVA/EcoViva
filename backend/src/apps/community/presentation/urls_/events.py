                ...
                path(
                    ...
                    include(
                        [
                            ...
                            path(
                                "competitors/create/",
                                ChallengeCompetitorCreateView.as_view(),
                                name="challenge-competitor-create",
                            ),
                            path(
                                "competitors/record/create/",
                                ChallengeRecordCreateView.as_view(),
                                name="challenge-record-create",
                            ),
                            path(
                                "competitors/delete/<int:id_competitor>/",
                                ChallengeCompetitorDeleteView.as_view(),
                                name="challenge-competitor-delete",
                            ),
                        ]
                    ),
                ),
                ...
                path(
                    ...
                    include(
                        [
                            ...
                            path(
                                "join/",
                                ToggleCampaignParticipationView.as_view(),
                                name="campaign-toggle",
                            ),
                            path(
                                "participants/",
                                ListParticipantsView.as_view(),
